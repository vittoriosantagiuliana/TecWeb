...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="it" lang="it">
	<head>
		...
		<title>Zoo - Animali - Pecora</title>
	...
	<body>
		...
		<div id="breadcrumb">
			<p><a href="../index.php">Home</a> &#124; <a href="../animals.php">Animali</a> &#124; Pecora </p>
		</div>
		<div id="content">
            <h2>Pecora</h2>
			<img class="descriptionImage" src="../images/animals/sheep.jpg" alt="pecora"/>
			<p class="description">
				<strong>Nome comune&colon;</strong> Pecora<br/>
				<strong>Nome scientifico&colon;</strong><span xml:lang="la"> Ovis Aries</span><br/>
