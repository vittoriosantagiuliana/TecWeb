function checkForm () {
	...
	var emailinputInput = document.forms.namedItem("contact_form")["email"];

	emailinputInput.onchange = function () {
		if (!emailRegExp.test(emailinputInput.value))
			emailinputInput.value = "";
	}
}